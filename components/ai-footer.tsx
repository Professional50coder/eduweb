    ...
    <footer className="border-t border-border/50 bg-gradient-to-t from-primary/5 to-transparent py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="text-2xl font-bold mb-2 text-white">ConsultAI</div>
            <p className="text-sm text-white/70">Designed for secure, production-grade AI systems.</p>
          </div>
        ...
        <div className="border-t border-border/50 pt-8 text-center text-sm text-white/60">
          <p>© 2025 ConsultAI. Built for engineering teams solving real problems.</p>
        </div>
      </div>
    </footer>
  )
