  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 py-20 mt-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          We Design AI Systems That Actually Run Your Business
        </h1>

        <p
          className="text-lg md:text-xl text-white opacity-85 mb-8 text-balance max-w-2xl mx-auto leading-relaxed animate-slideInUp"
